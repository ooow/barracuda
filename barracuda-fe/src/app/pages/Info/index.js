    ...
    return (
      <div className='container'>
        ...
        <div className='container col-sm-6 col-10 mt-4 text-justify info-text'>
          ...
          The <strong>"Barracuda"</strong> is a text analyzer. It provides the
          ability to check your text for obscene language. Text recognition
          works in live mode and uses self-studied artificial intelligence. In
          addition, you have the opportunity to train and improve the algorithm
          manually.
